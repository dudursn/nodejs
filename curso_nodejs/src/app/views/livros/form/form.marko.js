...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Cadastro de livros</h1><form action=\"/livros\" method=\"post\"><input type=\"hidden\" id=\"id\" name=\"id\" value=\"" +
    ...
    "</textarea></div><input type=\"submit\" value=\"Salvar\"><button onclick=\"livroController.voltar('/livros')\">Voltar</button></form><script src=\"/js/controller/LivroController.js\"></script> <script>\r\n            \r\n            let livroController = new LivroController();\r\n        </script>");
